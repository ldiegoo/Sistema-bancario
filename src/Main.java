...
public class Main {
    public static void main(String[] args) {
        ...
        Cliente cliente = new Cliente(
                ...
                "Chapito",              // apellidos
                "XAXX010101000",                // RFC
                "XAXX010101HDFABC09",           // CURP
                "Calle Falsa 123, CDMX",        // direccion
                "555-123-4567",                 // telefono
                "123",           // contrasenia
                "2023-12-01",                   // fechaRegistro
                "Sucursal Central, CDMX",       // direccionRegistro
                "Sucursal Centro Histórico"     // sucursalRegistro
        );
